...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="relative min-h-screen bg-[#070913] py-28 text-white px-6 md:px-8 print:hidden">
          ...
          {SERVICES_LIST.map((srv: Service, index) => {
            ...
            return (
              <motion.div
                ...
                } p-8 sm:p-12 backdrop-blur-xl transition-all duration-300 hover:border-cyan-400`}
              >
                {/* Popular Accent Glow Banner */}
                {srv.popular && (
                  <div className="absolute -top-4 right-8 inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-cyan-400 to-indigo-500 px-4 py-1.5 text-xs font-black uppercase tracking-wider text-black shadow-lg">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-3xl font-black tracking-tight text-white group-hover:text-cyan-300 transition-colors">
                      {srv.title}
                    </h3>
                ...
                <div className="pt-8 mt-8 border-t border-white/10">
                  <button
                    ...
                    className={`group/btn flex w-full items-center justify-center gap-3 rounded-full py-4 text-base font-bold transition-all ${
                      srv.popular
